          ...
          {active === 'library' && (
            <>
              ...
              {getSection('library').rules && getSection('library').rules.length > 0 && (
                <div style={{ marginTop: '24px' }}>
                  <h3 style={{ fontFamily: 'Georgia, serif', fontSize: '18px', color: '#6A1B9A', marginBottom: '12px' }}>Library Rules</h3>
              ...
              {getSection('library').images && getSection('library').images.length > 0 && (
                <div style={{ marginTop: '24px' }}>
                  <h3 style={{ fontFamily: 'Georgia, serif', fontSize: '18px', color: '#6A1B9A', marginBottom: '14px' }}>Library Gallery</h3>
            ...
            <>
              ...
              {getSection('bus-facility').busRoutes && getSection('bus-facility').busRoutes.length > 0 && (
                <div style={{ marginTop: '28px' }}>
                  <h3 style={{ fontFamily: 'Georgia, serif', fontSize: '18px', color: '#6A1B9A', marginBottom: '16px' }}>Bus Routes</h3>
                    ...
                    {getSection('bus-facility').busRoutes.map((route, ri) => (
                      <div key={ri} style={{ background: '#fff', border: '1px solid #e4e8ed', borderRadius: '12px', padding: '20px 24px', position: 'relative', overflow: 'hidden' }}>
                        ...
                        <div style={{ display: 'flex', alignItems: 'center', gap: '12px', marginBottom: '20px' }}>
                          <div style={{ width: '40px', height: '40px', borderRadius: '10px', background: 'linear-gradient(135deg, #6A1B9A, #1a2642)', color: '#fff', display: 'flex', alignItems: 'center', justifyContent: 'center', fontSize: '18px' }}>🚌</div>
                          <div>
                            <h4 style={{ margin: 0, fontSize: '16px', fontWeight: 700, color: '#6A1B9A' }}>{route.routeName || `Route ${ri + 1}`}</h4>
                        ...
                        <div style={{ position: 'relative', paddingLeft: '20px' }}>
                          ...
                          {route.stops.map((stop, si) => (
                            <div key={si} style={{ display: 'flex', alignItems: 'center', gap: '14px', marginBottom: si < route.stops.length - 1 ? '0' : '0', position: 'relative', paddingBottom: si < route.stops.length - 1 ? '20px' : '0' }}>
                              {/* Stop dot */}
                              <div style={{ width: '24px', height: '24px', borderRadius: '50%', background: si === 0 ? '#27ae60' : si === route.stops.length - 1 ? '#c0392b' : '#6A1B9A', color: '#fff', display: 'flex', alignItems: 'center', justifyContent: 'center', fontSize: '10px', fontWeight: 700, zIndex: 1, flexShrink: 0, boxShadow: '0 2px 6px rgba(0,0,0,0.15)' }}>{si + 1}</div>
                              {/* Stop info */}
          ...
          {active === 'canteen' && (
            <>
              ...
              {getSection('canteen').foodMenu && getSection('canteen').foodMenu.length > 0 && (
                <div style={{ marginTop: '24px' }}>
                  <h3 style={{ fontFamily: 'Georgia, serif', fontSize: '18px', color: '#6A1B9A', marginBottom: '14px' }}>Food Menu</h3>
