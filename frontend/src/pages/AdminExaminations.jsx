    ...
    <div className="admission-preview-card">
      ...
      {form.resultPortalUrl ? (
        <div style={{ marginTop: '24px', textAlign: 'center' }}>
          <a href={form.resultPortalUrl} target="_blank" rel="noopener noreferrer" style={{ display: 'inline-flex', alignItems: 'center', gap: '10px', padding: '14px 36px', background: 'linear-gradient(135deg, #243358 0%, #3a5080 100%)', color: '#fff', fontSize: '16px', fontWeight: 600, borderRadius: '50px', textDecoration: 'none', boxShadow: '0 4px 15px rgba(36, 51, 88, 0.3)' }}>
