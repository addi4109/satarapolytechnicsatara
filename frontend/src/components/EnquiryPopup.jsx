          ...
          <>
            ...
            <div className="enquiry-left">
              <div className="enquiry-left-content">
                <div className="enquiry-badge">Admissions Open</div>
                <h2>Start Your<br />Engineering<br />Journey</h2>
                <p>
                  Fill in your details and our team will get in touch
                  with you within 24 hours.
                </p>
                <div className="enquiry-left-features">
                  ...
                  <div className="enquiry-feature">
                    <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2"><path d="M22 11.08V12a10 10 0 1 1-5.93-9.14"/><polyline points="22 4 12 14.01 9 11.01"/></svg>
                    <span>Excellent Placement Record</span>
                  </div>
                  <div className="enquiry-feature">
                    <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2"><path d="M22 11.08V12a10 10 0 1 1-5.93-9.14"/><polyline points="22 4 12 14.01 9 11.01"/></svg>
                    <span>AICTE Approved & MSBTE Affiliated</span>
                  </div>
                </div>
              </div>
            </div>
