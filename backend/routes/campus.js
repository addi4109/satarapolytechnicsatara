...
router.post('/', async (req, res) => {
  try {
    const { section, title, content, infoRows, stats, steps, staffMembers, tables, rules, images, active } = req.body;
    ...
    const entry = await Campus.findOneAndUpdate(
      { section },
      { section, title, content, infoRows, stats, steps, staffMembers, tables, rules, images, active },
